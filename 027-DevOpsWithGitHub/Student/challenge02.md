...
2. Next, download the code for the application [here](https://github.com/OCPDemos/WhatTheHack/blob/027-DevOps-with-GitHub/027-DevOpsWithGitHub/Student/Code/Application/Application.zip). Unzip the download and copy the contents into the root of the repository you just cloned.
